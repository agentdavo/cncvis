...
ADD_OP(TexSubImage1D, 7, "%d %d %d %d %d %d %p")
ADD_OP(TexSubImage2D, 9, "%d %d %d %d %d %d %d %d %p")
ADD_OP(CopyTexSubImage2D, 8, "%d %d %d %d %d %d %d %d")
ADD_OP(BindTexture, 2, "%C %d")
ADD_OP(TexEnvi, 3, "%d %d %d")
ADD_OP(TexParameter, 3, "%d %d %d")
