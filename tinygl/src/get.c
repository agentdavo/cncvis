...
#endif
#if (TGL_FEATURE_MULTITHREADED_DRAWPIXELS || TGL_FEATURE_MULTITHREADED_COPY_TEXIMAGE_2D || TGL_FEATURE_MULTITHREADED_ZB_COPYBUFFER ||                          \
	 TGL_FEATURE_MULTITHREADED_ZB_TRIANGLE)
