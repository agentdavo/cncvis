...
typedef float GLclampf;          /* single precision float clamped */
...
/* stubs for unimplemented 1.1 features */
...
void glTexImage2D(GLint target, GLint level, GLint components, GLint width,
                  GLint height, GLint border, GLint format, GLint type,
                  void *pixels);

void glTexImage1D(GLint target, GLint level, GLint components, GLint width,
                  GLint border, GLint format, GLint type, void *pixels);
...
void glBindBufferAsArray(GLenum target, GLuint buffer, GLenum type, GLint size,
                         GLint stride);
...
void glFogiv(GLint, const GLint *);
void glFogfv(GLint, const GLfloat *);
void glFogf(GLint, GLfloat);
